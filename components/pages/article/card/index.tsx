...
export default function ArticleCard({
  ...
  return (
    <Link
      ...
      className="p-4 relative transition-all group break-inside mb-8 border-theme-accent-opaque  duration-500 flex flex-col  rounded-md cursor-pointer  border-theme-accent hover:border-theme-primary border-opacity-10 hover:border-opacity-20"
    >
      <div
        ref={blob}
        style={{ opacity: 0.2 }}
        className="w-[35%]  top-[0%] left-[0%] transform-center hidden translate-y-[-1/2] 
