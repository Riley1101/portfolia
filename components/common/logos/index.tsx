...
export function SvelteIcon(props: LogoProps) {
  return (
    <Image src={svelteIcon} alt="Svelte Logo" className={props.className} />
  );
}

export function TypescriptIcon(props: LogoProps) {
  return (
    <svg
      className={props.className}
      xmlns="http://www.w3.org/2000/svg"
